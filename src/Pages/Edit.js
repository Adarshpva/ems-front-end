...
function Edit() {
  ...
  // state to hold existing image rom server
  const [existingImg,setexistingImg]= useState("")

  // get details of givemn id 
      ...
      <div className="container mt-5">
        ...
        <Card className='shadow mt-3 p-3'>
          <div className="text-center mb-3">
            <img className='rounded-circle' width={'100px'} height={'100px'} src={preview?preview:`${BASE_URL}/uploads/${existingImg}`} alt="profile" />
